...
python Markov_chain_approximation.py --min_prob 1e-3 --batch_size 786 --model_name pythia-160m-deduped-v0
python Markov_chain_approximation.py --min_prob 1e-3 --batch_size 786 --model_name pythia-410m-deduped-v0
